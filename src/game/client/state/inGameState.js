...
InGameState.prototype = Object.create(State.prototype);

InGameState.prototype.constructor = InGameState;

InGameState.prototype.onCreate = function(){
...
InGameState.prototype.onResize = function(width, height){
...
InGameState.prototype.onUpdate = function(){
 ...
 */
InGameState.prototype.playCountDown = function(){
